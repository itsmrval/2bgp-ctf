...
if [[ "$response" == "[]" ]]; then
    # Request 1: Croiseur
    send_request "Croiseur" 1 "Ton maitre te communique ta mission sur un holoprojecteur, déchiffre ce message et récupère le flag pour commencer ton aventure" "diabolic-atop-compress" "https://target1.2bgp-ctf.vpws.eu" 100
    ...
    Mais sous ces pixels se dissimule une énigme bien plus profonde. En laissant la Force guider votre intuition, vous vous devez de déchiffrez ces indices cachés." "untagged-disabled-arguable" "https://target2.2bgp-ctf.vpws.eu" 150
